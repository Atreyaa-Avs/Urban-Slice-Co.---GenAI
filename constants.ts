...
export const CAKE_CATALOG: Product[] = [
  ...
  {
    id: 'cake-013', slug: 'salted-caramel', name: 'Salted Caramel Indulgence', description: 'Caramel-soaked sponge, salted caramel buttercream, and crunchy praline.',
  ...
  {
    id: 'cake-014', slug: 'pistachio-rose', name: 'Pistachio Rose Cake', description: 'Delicate pistachio layers with rosewater cream.',
  ...
  {
    id: 'cake-015', slug: 'black-sesame', name: 'Black Sesame Silk', description: 'Earthy black sesame mousse and sponge—elegant umami twist.',
  ...
  {
    id: 'cake-016', slug: 'nutella-hazelnut', name: 'Nutella Hazelnut Gateau', description: 'Hazelnut sponge with Nutella cream and crunchy praline.',
  ...
  {
    id: 'cake-017', slug: 'berry-mascarpone', name: 'Berry & Mascarpone Torte', description: 'Fresh berries layered with mascarpone cream.',
  ...
  {
    id: 'cake-018', slug: 'vanilla-bean', name: 'Vanilla Bean Royale', description: 'Classic vanilla sponge infused with real vanilla bean.',
